...
| Metric | Value |
|:-------|:------|
| Tutorial directories | 121 |
| Tutorials with exactly 8 numbered chapters | 118 |
...
- `tiktoken-tutorial`: 8 numbered chapter files
- `teable-database-platform`: 8 numbered chapter files
