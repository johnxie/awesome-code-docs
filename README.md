...
|:---------------|:---------|------:|:----------|:---------------|
| [`open-webui/open-webui`](https://github.com/open-webui/open-webui) | [Open WebUI Tutorial](tutorials/open-webui-tutorial/) | 125,406 | 2026-03-02 (0d ago) | self-hosted AI interface and model operations |
| [`anomalyco/opencode`](https://github.com/anomalyco/opencode) | [OpenCode Tutorial](tutorials/opencode-tutorial/) | 113,977 | 2026-03-02 (0d ago) | terminal-native coding agent with strong provider and tool controls |
| [`browser-use/browser-use`](https://github.com/browser-use/browser-use) | [Browser Use Tutorial](tutorials/browser-use-tutorial/) | 79,345 | 2026-03-02 (0d ago) | browser-native AI automation and agent execution |
| [`daytonaio/daytona`](https://github.com/daytonaio/daytona) | [Daytona Tutorial](tutorials/daytona-tutorial/) | 61,571 | 2026-03-01 (1d ago) | sandbox infrastructure for secure AI code execution |
| [`cline/cline`](https://github.com/cline/cline) | [Cline Tutorial](tutorials/cline-tutorial/) | 58,540 | 2026-03-02 (0d ago) | agentic coding with terminal, browser, and MCP workflows |
| [`Mintplex-Labs/anything-llm`](https://github.com/Mintplex-Labs/anything-llm) | [AnythingLLM Tutorial](tutorials/anything-llm-tutorial/) | 55,260 | 2026-02-28 (2d ago) | self-hosted RAG workspaces and agent workflows |
| [`TabbyML/tabby`](https://github.com/TabbyML/tabby) | [Tabby Tutorial](tutorials/tabby-tutorial/) | 32,967 | 2026-03-02 (0d ago) | self-hosted coding assistant platform for teams |
| [`continuedev/continue`](https://github.com/continuedev/continue) | [Continue Tutorial](tutorials/continue-tutorial/) | 31,596 | 2026-03-02 (0d ago) | IDE-native AI coding assistant architecture |
| [`Fission-AI/OpenSpec`](https://github.com/Fission-AI/OpenSpec) | [OpenSpec Tutorial](tutorials/openspec-tutorial/) | 26,792 | 2026-02-27 (3d ago) | spec-driven workflow layer for predictable AI-assisted delivery |
...
| [`vercel/ai`](https://github.com/vercel/ai) | [Vercel AI SDK Tutorial](tutorials/vercel-ai-tutorial/) | 22,216 | 2026-03-01 (1d ago) | production TypeScript AI app and agent SDK patterns |
...
| [`stackblitz-labs/bolt.diy`](https://github.com/stackblitz-labs/bolt.diy) | [bolt.diy Tutorial](tutorials/bolt-diy-tutorial/) | 19,067 | 2026-02-07 (23d ago) | open-source Bolt-style product builder stack |
...
| [`cloudflare/vibesdk`](https://github.com/cloudflare/vibesdk) | [VibeSDK Tutorial](tutorials/vibesdk-tutorial/) | 4,824 | 2026-03-02 (0d ago) | Cloudflare-native prompt-to-app platform architecture |
