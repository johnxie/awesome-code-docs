...
QUERY_HUBS: tuple[dict[str, object], ...] = (
    ...
    },
    {
        ...
        "title": "Multi-Agent Frameworks and Orchestration",
        "cluster": "ai-coding-agents",
        "intents": ("agentic-coding", "architecture-deep-dive", "production-operations"),
        "must_have_terms": ("multi-agent", "agent", "orchestration"),
        "prefer_slugs": (
            "ag2-tutorial",
            "autogen-tutorial",
            "crewai-tutorial",
        ...
        "why": "Teams adopting agents need to compare orchestration models, handoff patterns, state, and production controls.",
    },
    {
        ...
        "cluster": "ai-coding-agents",
        "intents": ("agentic-coding", "production-operations"),
        "must_have_terms": ("review", "governance", "guardrail", "audit", "coding"),
        "prefer_slugs": (
            "agents-md-tutorial",
            "cline-tutorial",
            "roo-code-tutorial",
        ...
        "why": "AI-generated code creates immediate review, documentation, and cleanup demand after teams move past first demos.",
    },
    {
        "id": "local-first-self-hosted-ai",
        "title": "Local-First and Self-Hosted AI Stacks",
        "cluster": "llm-infra-serving",
        "intents": ("production-operations", "beginner-onboarding"),
        "must_have_terms": ("local", "self-hosted", "inference", "serv"),
        "prefer_slugs": (
            "ollama-tutorial",
            "localai-tutorial",
            "vllm-tutorial",
        ...
        "why": "Privacy-sensitive teams search for complete local and self-hosted paths from model serving to user interfaces.",
    },
    {
        "id": "agent-memory-and-knowledge",
        "title": "Agent Memory and Knowledge Systems",
        "cluster": "rag-and-retrieval",
        "intents": ("rag-implementation", "architecture-deep-dive", "production-operations"),
        "must_have_terms": ("memory", "knowledge", "retrieval", "rag", "vector"),
        "prefer_slugs": (
            "mem0-tutorial",
            "cipher-tutorial",
            "llamaindex-tutorial",
        ...
        "why": "Persistent context is a repeated blocker for useful agents, RAG systems, and team knowledge workflows.",
    },
    {
        "id": "agent-context-memory-skills",
        "title": "Agent Context, Memory, and Skills",
        "cluster": "ai-coding-agents",
        "intents": ("agentic-coding", "tool-selection", "architecture-deep-dive"),
        "must_have_terms": ("context", "memory", "skill", "agent", "instructions"),
        "prefer_slugs": (
            "context7-tutorial",
            "agents-md-tutorial",
            "claude-mem-tutorial",
        ...
        "why": "Agent quality often depends less on model choice than on durable instructions, reusable skills, and fresh context.",
    },
    {
        "id": "browser-automation-and-web-agents",
        "title": "Browser Automation and Web Agents",
        "cluster": "ai-coding-agents",
        "intents": ("agentic-coding", "production-operations"),
        "must_have_terms": ("browser", "web", "automation", "playwright"),
        "prefer_slugs": (
        ...
        "why": "Browser agents sit at the intersection of web automation, testing, scraping, and agentic coding workflows.",
    },
    {
        "id": "llm-observability-evals-guardrails",
        "title": "LLM Observability, Evals, and Guardrails",
        "cluster": "general-software",
        "intents": ("production-operations", "architecture-deep-dive"),
        "must_have_terms": ("observability", "eval", "guardrail", "prompt", "structured"),
        "prefer_slugs": (
            "langfuse-tutorial",
            "humanlayer-tutorial",
            "instructor-tutorial",
        ...
        "why": "Production teams need proof that AI systems are measurable, reviewable, and controllable before rollout.",
    },
    {
        "id": "workflow-automation-and-internal-tools",
        "title": "Workflow Automation and Internal AI Tools",
        "cluster": "ai-app-frameworks",
        "intents": ("production-operations", "beginner-onboarding"),
        "must_have_terms": ("workflow", "automation", "tool", "app"),
        "prefer_slugs": (
        ...
        "why": "Automation and internal-tool searches often convert into concrete platform adoption and implementation work.",
    },
    {
        "id": "ai-data-platforms-and-analytics",
        "title": "AI Data Platforms, Analytics, and Storage",
        "cluster": "data-and-storage",
        "intents": ("architecture-deep-dive", "production-operations"),
        "must_have_terms": ("database", "storage", "analytics", "search", "knowledge"),
        "prefer_slugs": (
            "postgresql-tutorial",
            "clickhouse-tutorial",
            "supabase-tutorial",
        ...
        "why": "Most AI applications need durable data, search, analytics, and knowledge-management foundations.",
    },
)
