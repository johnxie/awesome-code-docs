...
- stars: about **28.2k**
- GitHub release reference: [`v1.26.0`](https://github.com/huggingface/smolagents/releases/tag/v1.26.0) (checked 2026-07-06; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Smolagents](01-getting-started.md)
2. [Chapter 2: Understanding Smolagents](02-understanding-agents.md)
3. [Chapter 3: Tools & Functions](03-tools.md)
4. [Chapter 4: Safe Code Execution](04-code-execution.md)
5. [Chapter 5: Multi-Step Reasoning](05-multi-step.md)
6. [Chapter 6: Memory & Context](06-memory.md)
7. [Chapter 7: Advanced Patterns](07-advanced.md)
8. [Chapter 8: Production Deployment & Operations](08-production.md)
