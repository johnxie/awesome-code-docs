...
- stars: about **6.7k**
- GitHub release reference: [`stagewise@1.10.0`](https://github.com/stagewise-io/stagewise/releases/tag/stagewise@1.10.0) (checked 2026-06-22; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and CLI Bootstrap](01-getting-started-and-cli-bootstrap.md)
...
1. [Chapter 1: Getting Started and CLI Bootstrap](01-getting-started-and-cli-bootstrap.md)
2. [Chapter 2: Proxy and Toolbar Architecture](02-proxy-and-toolbar-architecture.md)
3. [Chapter 3: Bridge Mode and Multi-Agent Integrations](03-bridge-mode-and-multi-agent-integrations.md)
4. [Chapter 4: Configuration and Plugin Loading](04-configuration-and-plugin-loading.md)
5. [Chapter 5: Building Plugins with Plugin SDK](05-building-plugins-with-plugin-sdk.md)
6. [Chapter 6: Custom Agent Integrations with Agent Interface](06-custom-agent-integrations-with-agent-interface.md)
7. [Chapter 7: Troubleshooting, Security, and Operations](07-troubleshooting-security-and-operations.md)
8. [Chapter 8: Contribution Workflow and Ecosystem Evolution](08-contribution-workflow-and-ecosystem-evolution.md)
