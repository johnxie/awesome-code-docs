...
After working through this chapter, you should be able to reason about `Chapter 7: Advanced Patterns` as an operating subsystem inside **OpenAI Realtime Agents Tutorial: Voice-First AI Systems**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Previous Chapter: Chapter 6: Voice Output](06-voice-output.md)
