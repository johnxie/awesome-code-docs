...
- stars: about **28.3k**
- GitHub release reference: [`1.5.9`](https://github.com/chroma-core/chroma/releases/tag/1.5.9) (checked 2026-06-08; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Chroma](01-getting-started.md)
2. [Chapter 2: Collections & Documents](02-collections-documents.md)
3. [Chapter 3: Embeddings & Indexing](03-embeddings-indexing.md)
4. [Chapter 4: Querying & Retrieval](04-querying-retrieval.md)
5. [Chapter 5: Metadata & Filtering](05-metadata-filtering.md)
6. [Chapter 6: Integration Patterns](06-integration-patterns.md)
