...
- stars: about **13.1k**
- GitHub release reference: [`@modelcontextprotocol/fastify@2.0.0`](https://github.com/modelcontextprotocol/typescript-sdk/releases/tag/@modelcontextprotocol/fastify@2.0.0) (checked 2026-08-10; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and Package Model](01-getting-started-and-package-model.md)
...
1. [Chapter 1: Getting Started and Package Model](01-getting-started-and-package-model.md)
2. [Chapter 2: Server Transports and Deployment Patterns](02-server-transports-and-deployment-patterns.md)
3. [Chapter 3: Client Transports, OAuth, and Backwards Compatibility](03-client-transports-oauth-and-backwards-compatibility.md)
4. [Chapter 4: Tool, Resource, Prompt Design and Completions](04-tool-resource-prompt-design-and-completions.md)
5. [Chapter 5: Sampling, Elicitation, and Experimental Tasks](05-sampling-elicitation-and-experimental-tasks.md)
6. [Chapter 6: Middleware, Security, and Host Validation](06-middleware-security-and-host-validation.md)
7. [Chapter 7: v1 to v2 Migration Strategy](07-v1-to-v2-migration-strategy.md)
8. [Chapter 8: Conformance Testing and Contribution Workflows](08-conformance-testing-and-contribution-workflows.md)
