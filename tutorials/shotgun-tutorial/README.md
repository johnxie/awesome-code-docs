...
- stars: about **679**
- GitHub release reference: [`0.13.0`](https://github.com/shotgun-sh/shotgun/releases/tag/0.13.0) (checked 2026-06-15; release metadata on GitHub)
...
2. [Chapter 2: Router Architecture and Agent Lifecycle](02-router-architecture-and-agent-lifecycle.md)
3. [Chapter 3: Planning vs Drafting Execution Modes](03-planning-vs-drafting-execution-modes.md)
4. [Chapter 4: Codebase Indexing and Context Retrieval](04-codebase-indexing-and-context-retrieval.md)
5. [Chapter 5: CLI Automation and Scripting](05-cli-automation-and-scripting.md)
6. [Chapter 6: Context7 MCP and Local Models](06-context7-mcp-and-local-models.md)
7. [Chapter 7: Spec Sharing and Collaboration Workflows](07-spec-sharing-and-collaboration-workflows.md)
8. [Chapter 8: Production Operations, Observability, and Security](08-production-operations-observability-and-security.md)
