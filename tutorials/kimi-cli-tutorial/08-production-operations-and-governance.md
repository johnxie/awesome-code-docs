...
After working through this chapter, you should be able to reason about `Chapter 8: Production Operations and Governance` as an operating subsystem inside **Kimi CLI Tutorial: Multi-Mode Terminal Agent with MCP and ACP**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Previous Chapter: Chapter 7: Loop Control, Retries, and Long Tasks](07-loop-control-retries-and-long-tasks.md)
