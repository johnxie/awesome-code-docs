...
After working through this chapter, you should be able to reason about `Chapter 8: Production Operations and Governance` as an operating subsystem inside **Mistral Vibe Tutorial: Minimal CLI Coding Agent by Mistral**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Previous Chapter: Chapter 7: ACP and Editor Integrations](07-acp-and-editor-integrations.md)
