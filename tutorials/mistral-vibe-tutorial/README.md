...
- stars: about **4.6k**
- GitHub release reference: [`v2.17.1`](https://github.com/mistralai/mistral-vibe/releases/tag/v2.17.1) (checked 2026-06-22; release metadata on GitHub)
...
2. [Chapter 2: Agent Profiles and Trust Model](02-agent-profiles-and-trust-model.md)
3. [Chapter 3: Tooling and Approval Workflow](03-tooling-and-approval-workflow.md)
4. [Chapter 4: Skills and Slash Command Extensions](04-skills-and-slash-command-extensions.md)
5. [Chapter 5: Subagents and Task Delegation](05-subagents-and-task-delegation.md)
6. [Chapter 6: Programmatic and Non-Interactive Modes](06-programmatic-and-non-interactive-modes.md)
7. [Chapter 7: ACP and Editor Integrations](07-acp-and-editor-integrations.md)
