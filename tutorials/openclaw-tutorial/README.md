...
- stars: about **386k**
- GitHub release reference: [`v2026.7.1-2`](https://github.com/openclaw/openclaw/releases/tag/v2026.7.1-2) (checked 2026-08-10; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with OpenClaw](01-getting-started.md)
2. [Chapter 2: Gateway Architecture](02-gateway-architecture.md)
3. [Chapter 3: Channel Drivers](03-channel-drivers.md)
4. [Chapter 4: Agent Runtime](04-agent-runtime.md)
5. [Chapter 5: Memory & Sessions](05-memory-sessions.md)
6. [Chapter 6: Skills & Tools](06-skills-tools.md)
7. [Chapter 7: Security & Networking](07-security-networking.md)
