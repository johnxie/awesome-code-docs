...
- stars: about **24.3k**
- GitHub release reference: [`v3.54.0`](https://github.com/RooCodeInc/Roo-Code/releases/tag/v3.54.0) (checked 2026-06-29; release metadata on GitHub)
- status: **archived**
...
2. [Chapter 2: Modes and Task Design](02-modes-and-task-design.md)
3. [Chapter 3: File and Command Operations](03-file-and-command-operations.md)
4. [Chapter 4: Context and Indexing](04-context-and-indexing.md)
5. [Chapter 5: Checkpoints and Recovery](05-checkpoints-and-recovery.md)
6. [Chapter 6: MCP and Tool Extensions](06-mcp-and-tool-extensions.md)
7. [Chapter 7: Profiles and Team Standards](07-profiles-and-team-standards.md)
