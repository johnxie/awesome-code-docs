...
- stars: about **2k**
- GitHub release reference: [`v2.1.2`](https://github.com/modelcontextprotocol/mcpb/releases/tag/v2.1.2) (checked 2026-06-22; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and Bundle Fundamentals](01-getting-started-and-bundle-fundamentals.md)
...
1. [Chapter 1: Getting Started and Bundle Fundamentals](01-getting-started-and-bundle-fundamentals.md)
2. [Chapter 2: Manifest Model, Metadata, and Compatibility](02-manifest-model-metadata-and-compatibility.md)
3. [Chapter 3: Server Configuration and Runtime Packaging](03-server-configuration-and-runtime-packaging.md)
4. [Chapter 4: Tools, Prompts, User Config, and Localization](04-tools-prompts-user-config-and-localization.md)
5. [Chapter 5: CLI Workflows: Init, Validate, and Pack](05-cli-workflows-init-validate-and-pack.md)
6. [Chapter 6: Signing, Verification, and Trust Controls](06-signing-verification-and-trust-controls.md)
7. [Chapter 7: Examples, Language Patterns, and Distribution Readiness](07-examples-language-patterns-and-distribution-readiness.md)
8. [Chapter 8: Release, Governance, and Ecosystem Operations](08-release-governance-and-ecosystem-operations.md)
