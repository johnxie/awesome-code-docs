...
- stars: about **35.3k**
- GitHub release reference: [`v0.0.78`](https://github.com/microsoft/playwright-mcp/releases/tag/v0.0.78) (checked 2026-07-20; release metadata on GitHub)
...
2. [Chapter 2: Operating Model: Accessibility Snapshots](02-operating-model-accessibility-snapshots.md)
3. [Chapter 3: Installation Across Host Clients](03-installation-across-host-clients.md)
4. [Chapter 4: Configuration, Capabilities, and Runtime Modes](04-configuration-capabilities-and-runtime-modes.md)
5. [Chapter 5: Profile State, Extension, and Auth Sessions](05-profile-state-extension-and-auth-sessions.md)
6. [Chapter 6: Standalone and Docker Deployment](06-standalone-and-docker-deployment.md)
7. [Chapter 7: Tooling Surface and Automation Patterns](07-tooling-surface-and-automation-patterns.md)
8. [Chapter 8: Troubleshooting, Security, and Contribution](08-troubleshooting-security-and-contribution.md)
