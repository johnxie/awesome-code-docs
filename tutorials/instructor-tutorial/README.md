...
- stars: about **13.5k**
- GitHub release reference: [`v1.15.4`](https://github.com/instructor-ai/instructor/releases/tag/v1.15.4) (checked 2026-07-13; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Instructor](01-getting-started.md)
2. [Chapter 2: Crafting Effective Pydantic Models](02-pydantic-models.md)
3. [Chapter 3: Validation, Errors, and Retries](03-validation.md)
4. [Chapter 4: Complex Structures and Nested Data](04-complex.md)
5. [Chapter 5: Streaming Structured Outputs](05-streaming.md)
6. [Chapter 6: Using Multiple Providers](06-providers.md)
7. [Chapter 7: Advanced Patterns and Guardrails](07-advanced.md)
8. [Chapter 8: Production Use and Operations](08-production.md)
