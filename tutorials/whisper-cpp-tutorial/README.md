...
- stars: about **50.9k**
- GitHub release reference: [`v1.9.1`](https://github.com/ggml-org/whisper.cpp/releases/tag/v1.9.1) (checked 2026-06-22; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Whisper.cpp](01-getting-started.md)
2. [Chapter 2: Audio Processing Fundamentals](02-audio-processing.md)
3. [Chapter 3: Model Architecture & GGML](03-model-architecture.md)
4. [Chapter 4: Core API & Usage Patterns](04-core-api.md)
5. [Chapter 5: Real-Time Streaming](05-real-time-streaming.md)
6. [Chapter 6: Language & Translation](06-language-translation.md)
7. [Chapter 7: Platform Integration](07-platform-integration.md)
8. [Chapter 8: Production Deployment](08-deployment-production.md)
