...
- stars: about **59.1k**
- GitHub release reference: [`python-v0.7.5`](https://github.com/microsoft/autogen/releases/tag/python-v0.7.5) (checked 2026-06-22; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Microsoft AutoGen](01-getting-started.md)
2. [Chapter 2: Agent Architecture & Roles](02-agent-architecture.md)
3. [Chapter 3: Agent Communication](03-agent-communication.md)
4. [Chapter 4: Tool Integration](04-tool-integration.md)
5. [Chapter 5: Task Decomposition](05-task-decomposition.md)
6. [Chapter 6: Custom Agent Development](06-custom-agents.md)
7. [Chapter 7: Multi-Agent Workflows](07-multi-agent-workflows.md)
