...
- stars: about **49.8k**
- GitHub release reference: [`v0.14.22`](https://github.com/run-llama/llama_index/releases/tag/v0.14.22) (checked 2026-06-02; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with LlamaIndex](01-getting-started.md)
2. [Chapter 2: Data Ingestion & Loading](02-data-ingestion.md)
3. [Chapter 3: Indexing & Storage](03-indexing-storage.md)
4. [Chapter 4: Query Engines & Retrieval](04-query-engines.md)
5. [Chapter 5: Advanced RAG Patterns](05-advanced-rag.md)
6. [Chapter 6: Custom Components](06-custom-components.md)
7. [Chapter 7: Production Deployment](07-production-deployment.md)
8. [Chapter 8: Monitoring & Optimization](08-monitoring-optimization.md)
