...
- stars: about **50k**
- GitHub release reference: [`v1.38.0`](https://github.com/block/goose/releases/tag/v1.38.0) (checked 2026-06-22; release metadata on GitHub)
...
2. [Chapter 2: Architecture and Agent Loop](02-architecture-and-agent-loop.md)
3. [Chapter 3: Providers and Model Routing](03-providers-and-model-routing.md)
4. [Chapter 4: Permissions and Tool Governance](04-permissions-and-tool-governance.md)
5. [Chapter 5: Sessions and Context Management](05-sessions-and-context-management.md)
6. [Chapter 6: Extensions and MCP Integration](06-extensions-and-mcp-integration.md)
7. [Chapter 7: CLI Workflows and Automation](07-cli-workflows-and-automation.md)
