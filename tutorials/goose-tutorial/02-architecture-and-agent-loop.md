...
After working through this chapter, you should be able to reason about `Chapter 2: Architecture and Agent Loop` as an operating subsystem inside **Goose Tutorial: Extensible Open-Source AI Agent for Real Engineering Work**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Next Chapter: Chapter 3: Providers and Model Routing](03-providers-and-model-routing.md)
