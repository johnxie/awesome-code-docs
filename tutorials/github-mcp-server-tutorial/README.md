...
- stars: about **32.5k**
- GitHub release reference: [`v1.10.1`](https://github.com/github/github-mcp-server/releases/tag/v1.10.1) (checked 2026-08-24; release metadata on GitHub)
...
2. [Chapter 2: Remote vs Local Architecture](02-remote-vs-local-architecture.md)
3. [Chapter 3: Authentication and Token Strategy](03-authentication-and-token-strategy.md)
4. [Chapter 4: Toolsets, Tools, and Dynamic Discovery](04-toolsets-tools-and-dynamic-discovery.md)
5. [Chapter 5: Host Integration Patterns](05-host-integration-patterns.md)
6. [Chapter 6: Security, Governance, and Enterprise Controls](06-security-governance-and-enterprise-controls.md)
7. [Chapter 7: Troubleshooting, Read-Only, and Lockdown Operations](07-troubleshooting-read-only-and-lockdown-operations.md)
8. [Chapter 8: Contribution and Upgrade Workflow](08-contribution-and-upgrade-workflow.md)
