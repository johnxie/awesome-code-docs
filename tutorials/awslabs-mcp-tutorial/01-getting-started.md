...
After working through this chapter, you should be able to reason about `Chapter 1: Getting Started` as an operating subsystem inside **awslabs/mcp Tutorial: Operating a Large-Scale MCP Server Ecosystem for AWS Workloads**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Next Chapter: Chapter 2: Server Catalog and Role Composition](02-server-catalog-and-role-composition.md)
