...
- stars: about **29.1k**
- GitHub release reference: [`v3.185.0`](https://github.com/langfuse/langfuse/releases/tag/v3.185.0) (checked 2026-06-15; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started with Langfuse](01-getting-started.md)
...
1. [Chapter 1: Getting Started with Langfuse](01-getting-started.md)
2. [Chapter 2: Tracing Fundamentals](02-tracing.md)
3. [Chapter 3: Prompt Management](03-prompts.md)
4. [Chapter 4: Evaluation](04-evaluation.md)
5. [Chapter 5: Analytics & Metrics](05-analytics.md)
6. [Chapter 6: Datasets & Testing](06-datasets.md)
7. [Chapter 7: Integrations](07-integrations.md)
