...
- stars: about **36.8k**
- GitHub release reference: [`python-sdk/v0.1.95`](https://github.com/CopilotKit/CopilotKit/releases/tag/python-sdk/v0.1.95) (checked 2026-08-17; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with CopilotKit](01-getting-started.md)
2. [Chapter 2: Reading App Context - Making Your App State Visible to AI](02-app-context.md)
3. [Chapter 3: Copilot Actions - Enabling AI to Take Actions in Your App](03-copilot-actions.md)
4. [Chapter 4: Chat Components - Building Chat Interfaces with CopilotChat and CopilotSidebar](04-chat-components.md)
5. [Chapter 5: Generative UI - AI-Generated React Components](05-generative-ui.md)
6. [Chapter 6: CoAgents & LangGraph - Building Agentic Workflows](06-coagents.md)
7. [Chapter 7: Human-in-the-Loop - User Approval Flows and Interrupts](07-human-in-loop.md)
8. [Chapter 8: Production Deployment - Secure, Scalable Copilot Apps](08-production.md)
