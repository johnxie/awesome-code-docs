...
- stars: about **476**
- GitHub release reference: [`v1.0.5`](https://github.com/modelcontextprotocol/create-python-server/releases/tag/v1.0.5) (checked 2026-07-20; release metadata on GitHub)
- status: **archived**
...
- [Start Here: Chapter 1: Getting Started and Scaffolding Workflow](01-getting-started-and-scaffolding-workflow.md)
...
1. [Chapter 1: Getting Started and Scaffolding Workflow](01-getting-started-and-scaffolding-workflow.md)
2. [Chapter 2: Generated Project Structure and Conventions](02-generated-project-structure-and-conventions.md)
3. [Chapter 3: Template Server Architecture: Resources, Prompts, and Tools](03-template-server-architecture-resources-prompts-and-tools.md)
4. [Chapter 4: Runtime, Dependencies, and uv Packaging](04-runtime-dependencies-and-uv-packaging.md)
5. [Chapter 5: Local Integration: Claude Desktop and Inspector](05-local-integration-claude-desktop-and-inspector.md)
6. [Chapter 6: Customization and Extension Patterns](06-customization-and-extension-patterns.md)
7. [Chapter 7: Quality, Security, and Contribution Workflows](07-quality-security-and-contribution-workflows.md)
8. [Chapter 8: Archived Status, Migration, and Long-Term Operations](08-archived-status-migration-and-long-term-operations.md)
