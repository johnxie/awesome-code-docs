...
- stars: about **7k**
- GitHub release reference: [`v3.2.1`](https://github.com/firecrawl/firecrawl-mcp-server/releases/tag/v3.2.1) (checked 2026-07-20; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and Core Setup](01-getting-started-and-core-setup.md)
...
1. [Chapter 1: Getting Started and Core Setup](01-getting-started-and-core-setup.md)
2. [Chapter 2: Architecture, Transports, and Versioning](02-architecture-transports-and-versioning.md)
3. [Chapter 3: Tool Selection: Scrape, Map, Crawl, Search, Extract](03-tool-selection-scrape-map-crawl-search-extract.md)
4. [Chapter 4: Client Integrations: Cursor, Claude, Windsurf, VS Code](04-client-integrations-cursor-claude-windsurf-vscode.md)
5. [Chapter 5: Configuration, Retries, and Credit Monitoring](05-configuration-retries-and-credit-monitoring.md)
6. [Chapter 6: Batch Workflows, Deep Research, and API Evolution](06-batch-workflows-deep-research-and-api-evolution.md)
7. [Chapter 7: Reliability, Observability, and Failure Handling](07-reliability-observability-and-failure-handling.md)
8. [Chapter 8: Security, Governance, and Contribution Workflow](08-security-governance-and-contribution-workflow.md)
