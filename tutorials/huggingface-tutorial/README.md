...
[![Stars](https://img.shields.io/github/stars/huggingface/transformers?style=social)](https://github.com/huggingface/transformers)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![Python](https://img.shields.io/badge/Python-blue)](https://github.com/huggingface/transformers)
...
- stars: about **163k**
- GitHub release reference: [`v5.14.1`](https://github.com/huggingface/transformers/releases/tag/v5.14.1) (checked 2026-07-20; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with HuggingFace Transformers](01-getting-started.md)
2. [Chapter 2: Text Classification & Analysis](02-text-classification.md)
3. [Chapter 3: Text Generation](03-text-generation.md)
4. [Chapter 4: Question Answering](04-question-answering.md)
5. [Chapter 5: Named Entity Recognition](05-named-entity-recognition.md)
6. [Chapter 6: Translation & Multilingual Models](06-translation-multilingual.md)
7. [Chapter 7: Fine-tuning Models](07-fine-tuning.md)
