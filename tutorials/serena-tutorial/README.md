...
- stars: about **25.6k**
- GitHub release reference: [`v1.5.3`](https://github.com/oraios/serena/releases/tag/v1.5.3) (checked 2026-06-22; release metadata on GitHub)
...
2. [Chapter 2: Semantic Toolkit and Agent Loop](02-semantic-toolkit-and-agent-loop.md)
3. [Chapter 3: MCP Client Integrations](03-mcp-client-integrations.md)
4. [Chapter 4: Language Backends and Analysis Strategy](04-language-backends-and-analysis-strategy.md)
5. [Chapter 5: Project Workflow and Context Practices](05-project-workflow-and-context-practices.md)
6. [Chapter 6: Configuration and Operational Controls](06-configuration-and-operational-controls.md)
7. [Chapter 7: Extending Serena and Custom Agent Integration](07-extending-serena-and-custom-agent-integration.md)
