...
- stars: about **17.8k**
- GitHub release reference: [`v1.107.0`](https://github.com/pydantic/pydantic-ai/releases/tag/v1.107.0) (checked 2026-06-15; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Pydantic AI](01-getting-started.md)
2. [Chapter 2: Advanced Model Configuration & Provider Setup](02-model-configuration.md)
3. [Chapter 3: Structured Outputs & Pydantic Models](03-structured-outputs.md)
4. [Chapter 4: Dependencies, Tools & External Integrations](04-dependencies-tools.md)
5. [Chapter 5: Streaming Responses & Async Operations](05-streaming-async.md)
6. [Chapter 6: Error Handling, Retry Mechanisms & Recovery](06-error-handling.md)
7. [Chapter 7: Advanced Patterns & Multi-Step Workflows](07-advanced-patterns.md)
8. [Chapter 8: Production Deployment & Scaling Pydantic AI Systems](08-production.md)
