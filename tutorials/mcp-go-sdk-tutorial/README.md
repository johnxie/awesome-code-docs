...
- stars: about **4.8k**
- GitHub release reference: [`v1.6.1`](https://github.com/modelcontextprotocol/go-sdk/releases/tag/v1.6.1) (checked 2026-07-20; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and SDK Package Map](01-getting-started-and-sdk-package-map.md)
...
1. [Chapter 1: Getting Started and SDK Package Map](01-getting-started-and-sdk-package-map.md)
2. [Chapter 2: Client/Server Lifecycle and Session Management](02-client-server-lifecycle-and-session-management.md)
3. [Chapter 3: Transports: stdio, Streamable HTTP, and Custom Flows](03-transports-stdio-streamable-http-and-custom-flows.md)
4. [Chapter 4: Building Tools, Resources, and Prompts in Go](04-building-tools-resources-and-prompts-in-go.md)
5. [Chapter 5: Client Capabilities: Roots, Sampling, and Elicitation](05-client-capabilities-roots-sampling-and-elicitation.md)
6. [Chapter 6: Auth, Security, and Runtime Hardening](06-auth-security-and-runtime-hardening.md)
7. [Chapter 7: Testing, Troubleshooting, and Rough Edges](07-testing-troubleshooting-and-rough-edges.md)
8. [Chapter 8: Conformance, Operations, and Upgrade Strategy](08-conformance-operations-and-upgrade-strategy.md)
