...
1. **Context bootstrap**: initialize runtime config and prerequisites for `extract`.
...
- search upstream code for `extract` and `print` to map concrete implementation paths
