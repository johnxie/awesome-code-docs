...
- stars: about **107k**
- GitHub release reference: [`v1.26.07`](https://github.com/supabase/supabase/releases/tag/v1.26.07) (checked 2026-07-20; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Supabase](01-getting-started.md)
2. [Chapter 2: Database Design & Management](02-database-design.md)
3. [Chapter 3: Authentication & Authorization](03-authentication.md)
4. [Chapter 4: Real-time Features](04-realtime-features.md)
5. [Chapter 5: Storage & File Management](05-storage-management.md)
6. [Chapter 6: Edge Functions](06-edge-functions.md)
7. [Chapter 7: Advanced Queries & RLS](07-advanced-queries.md)
