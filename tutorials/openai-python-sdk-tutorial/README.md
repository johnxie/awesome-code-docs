...
- stars: about **30.9k**
- GitHub release reference: [`v2.38.0`](https://github.com/openai/openai-python/releases/tag/v2.38.0) (checked 2026-06-02; release metadata on GitHub)
...
2. [Chapter 2: Chat Completions](02-chat-completions.md)
3. [Chapter 3: Embeddings and Search](03-embeddings-search.md)
4. [Chapter 4: Agents and Assistants](04-assistants-api.md)
5. [Chapter 5: Batch Processing](05-batch-processing.md)
6. [Chapter 6: Fine-Tuning](06-fine-tuning.md)
7. [Chapter 7: Advanced Patterns](07-advanced-patterns.md)
8. [Chapter 8: Integration Examples](08-integration-examples.md)
