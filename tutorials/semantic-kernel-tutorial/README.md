...
- stars: about **28.1k**
- GitHub release reference: [`python-1.43.0`](https://github.com/microsoft/semantic-kernel/releases/tag/python-1.43.0) (checked 2026-06-08; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with Semantic Kernel](01-getting-started.md)
2. [Chapter 2: Plugins & Functions](02-plugins.md)
3. [Chapter 3: Prompt Engineering](03-prompts.md)
4. [Chapter 4: AI Services & Connectors](04-services.md)
5. [Chapter 5: Memory & Embeddings](05-memory.md)
6. [Chapter 6: Planners](06-planners.md)
7. [Chapter 7: Agents & Tool Use](07-agents.md)
