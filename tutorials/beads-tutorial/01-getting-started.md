...
After working through this chapter, you should be able to reason about `Chapter 1: Getting Started` as an operating subsystem inside **Beads Tutorial: Git-Backed Task Graph Memory for Coding Agents**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Next Chapter: Chapter 2: Architecture and Data Model](02-architecture-and-data-model.md)
