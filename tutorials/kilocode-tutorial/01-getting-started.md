...
After working through this chapter, you should be able to reason about `Chapter 1: Getting Started` as an operating subsystem inside **Kilo Code Tutorial: Agentic Engineering from IDE and CLI Surfaces**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Next Chapter: Chapter 2: Agent Loop and State Model](02-agent-loop-and-state-model.md)
