...
- stars: about **11.9k**
- GitHub release reference: [`v1.0.0`](https://github.com/hangwin/mcp-chrome/releases/tag/v1.0.0) (checked 2026-06-15; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and Native Bridge Setup](01-getting-started-and-native-bridge-setup.md)
...
1. [Chapter 1: Getting Started and Native Bridge Setup](01-getting-started-and-native-bridge-setup.md)
2. [Chapter 2: Architecture and Component Boundaries](02-architecture-and-component-boundaries.md)
3. [Chapter 3: Tool Surface: Browser, Network, and Interaction](03-tool-surface-browser-network-and-interaction.md)
4. [Chapter 4: Semantic Search and Vector Processing](04-semantic-search-and-vector-processing.md)
5. [Chapter 5: Transport Modes and Client Configuration](05-transport-modes-and-client-configuration.md)
6. [Chapter 6: Visual Editor and Prompt Workflows](06-visual-editor-and-prompt-workflows.md)
7. [Chapter 7: Troubleshooting, Permissions, and Security](07-troubleshooting-permissions-and-security.md)
8. [Chapter 8: Contribution, Release, and Runtime Operations](08-contribution-release-and-runtime-operations.md)
