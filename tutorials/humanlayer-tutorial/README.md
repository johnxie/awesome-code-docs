...
- stars: about **11.1k**
- GitHub release reference: [`pro-0.20.0`](https://github.com/humanlayer/humanlayer/releases/tag/pro-0.20.0) (checked 2026-06-29; release metadata on GitHub)
...
2. [Chapter 2: Architecture and Monorepo Layout](02-architecture-and-monorepo-layout.md)
3. [Chapter 3: Context Engineering Workflows](03-context-engineering-workflows.md)
4. [Chapter 4: Parallel Agent Orchestration](04-parallel-agent-orchestration.md)
5. [Chapter 5: Human Approval and High-Stakes Actions](05-human-approval-and-high-stakes-actions.md)
6. [Chapter 6: IDE and CLI Integration Patterns](06-ide-and-cli-integration-patterns.md)
7. [Chapter 7: Telemetry, Cost, and Team Governance](07-telemetry-cost-and-team-governance.md)
8. [Chapter 8: Production Rollout and Adoption](08-production-rollout-and-adoption.md)
