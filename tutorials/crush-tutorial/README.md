...
- stars: about **25.8k**
- GitHub release reference: [`v0.80.0`](https://github.com/charmbracelet/crush/releases/tag/v0.80.0) (checked 2026-06-29; release metadata on GitHub)
...
2. [Chapter 2: Architecture and Session Model](02-architecture-and-session-model.md)
3. [Chapter 3: Providers and Model Configuration](03-providers-and-model-configuration.md)
4. [Chapter 4: Permissions and Tool Controls](04-permissions-and-tool-controls.md)
5. [Chapter 5: LSP and MCP Integration](05-lsp-and-mcp-integration.md)
6. [Chapter 6: Skills, Commands, and Workflow Customization](06-skills-commands-and-workflow-customization.md)
7. [Chapter 7: Logs, Debugging, and Operations](07-logs-debugging-and-operations.md)
8. [Chapter 8: Production Governance and Rollout](08-production-governance-and-rollout.md)
