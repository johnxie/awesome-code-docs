...
- stars: about **81.6k**
- GitHub release reference: [`v0.22.0`](https://github.com/vllm-project/vllm/releases/tag/v0.22.0) (checked 2026-06-02; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with vLLM](01-getting-started.md)
2. [Chapter 2: Model Loading and Management](02-model-loading.md)
3. [Chapter 3: Basic Inference - Text Generation and Sampling](03-basic-inference.md)
4. [Chapter 4: Advanced Features - Streaming, Tool Calling, and Multi-Modal](04-advanced-features.md)
5. [Chapter 5: Performance Optimization - Maximizing Throughput and Efficiency](05-performance-optimization.md)
6. [Chapter 6: Distributed Inference - Scaling Across GPUs and Nodes](06-distributed-inference.md)
7. [Chapter 7: Production Deployment - Serving vLLM at Scale](07-production-deployment.md)
8. [Chapter 8: Monitoring & Scaling - Production Operations at Scale](08-monitoring-scaling.md)
