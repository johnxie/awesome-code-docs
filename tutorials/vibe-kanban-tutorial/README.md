...
- stars: about **26.7k**
- GitHub release reference: [`v0.1.44-20260424091429`](https://github.com/BloopAI/vibe-kanban/releases/tag/v0.1.44-20260424091429) (checked 2026-06-02; release metadata on GitHub)
...
3. [Chapter 3: Multi-Agent Execution Strategies](03-multi-agent-execution-strategies.md)
4. [Chapter 4: MCP and Configuration Control](04-mcp-and-configuration-control.md)
5. [Chapter 5: Review and Quality Gates](05-review-and-quality-gates.md)
6. [Chapter 6: Remote Access and Self-Hosting](06-remote-access-and-self-hosting.md)
7. [Chapter 7: Development and Source Build Workflow](07-development-and-source-build-workflow.md)
