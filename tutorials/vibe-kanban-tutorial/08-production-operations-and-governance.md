...
After working through this chapter, you should be able to reason about `Chapter 8: Production Operations and Governance` as an operating subsystem inside **Vibe Kanban Tutorial: Multi-Agent Orchestration Board for Coding Workflows**, with explicit contracts for inputs, state transitions, and outputs.
...
- [Previous Chapter: Chapter 7: Development and Source Build Workflow](07-development-and-source-build-workflow.md)
