...
- stars: about **10.9k**
- GitHub release reference: [`v1.0.70`](https://github.com/github/copilot-cli/releases/tag/v1.0.70) (checked 2026-07-13; release metadata on GitHub)
...
2. [Chapter 2: Authentication and Access Policies](02-authentication-and-access-policies.md)
3. [Chapter 3: Interactive Workflow and Approval Model](03-interactive-workflow-and-approval-model.md)
4. [Chapter 4: Models, Experimental Features, and Autopilot](04-models-experimental-features-and-autopilot.md)
5. [Chapter 5: MCP and LSP Extension Points](05-mcp-and-lsp-extension-points.md)
6. [Chapter 6: GitHub-Native Context Workflows](06-github-native-context-workflows.md)
7. [Chapter 7: Installation and Update Channels](07-installation-and-update-channels.md)
8. [Chapter 8: Production Governance and Team Rollout](08-production-governance-and-team-rollout.md)
