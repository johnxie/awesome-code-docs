...
- stars: about **9.9k**
- GitHub release reference: [`0.21.2-hotfix-3`](https://github.com/modelcontextprotocol/inspector/releases/tag/0.21.2-hotfix-3) (checked 2026-06-02; release metadata on GitHub)
...
2. [Chapter 2: Architecture, Transports, and Session Model](02-architecture-transports-and-session-model.md)
3. [Chapter 3: UI Debugging Workflows: Tools, Resources, Prompts](03-ui-debugging-workflows-tools-resources-prompts.md)
4. [Chapter 4: CLI Mode, Automation, and CI Loops](04-cli-mode-automation-and-ci-loops.md)
5. [Chapter 5: Security, Auth, and Network Hardening](05-security-auth-and-network-hardening.md)
6. [Chapter 6: Configuration, Timeouts, and Runtime Tuning](06-configuration-timeouts-and-runtime-tuning.md)
7. [Chapter 7: Inspector in Server Development Lifecycle](07-inspector-in-server-development-lifecycle.md)
8. [Chapter 8: Production Ops, Testing, and Contribution](08-production-ops-testing-and-contribution.md)
