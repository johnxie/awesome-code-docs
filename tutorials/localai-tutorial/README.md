...
- stars: about **46.6k**
- GitHub release reference: [`v4.3.6`](https://github.com/mudler/LocalAI/releases/tag/v4.3.6) (checked 2026-06-02; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with LocalAI](01-getting-started.md)
2. [Chapter 2: Model Gallery and Management](02-models.md)
3. [Chapter 3: Text Generation and Chat Completions](03-text-generation.md)
4. [Chapter 4: Image Generation with Stable Diffusion](04-image-generation.md)
5. [Chapter 5: Audio Processing - Whisper & TTS](05-audio.md)
6. [Chapter 6: Vector Embeddings for RAG](06-embeddings.md)
7. [Chapter 7: Advanced Configuration and Tuning](07-configuration.md)
8. [Chapter 8: Production Integration and Applications](08-integration.md)
