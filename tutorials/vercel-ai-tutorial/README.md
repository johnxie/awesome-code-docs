...
- stars: about **25.8k**
- GitHub release reference: [`@ai-sdk/google-vertex@5.0.31`](https://github.com/vercel/ai/releases/tag/@ai-sdk/google-vertex@5.0.31) (checked 2026-07-27; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started with Vercel AI](01-getting-started.md)
...
1. [Chapter 1: Getting Started with Vercel AI](01-getting-started.md)
2. [Chapter 2: Text Generation](02-text-generation.md)
3. [Chapter 3: Streaming Responses](03-streaming-responses.md)
4. [Chapter 4: Function Calling](04-function-calling.md)
5. [Chapter 5: Structured Outputs](05-structured-outputs.md)
6. [Chapter 6: React Integration](06-react-integration.md)
7. [Chapter 7: Next.js Applications](07-nextjs-applications.md)
