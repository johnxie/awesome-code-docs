...
- stars: about **19.5k**
- GitHub release reference: [`v1.0.0`](https://github.com/stackblitz-labs/bolt.diy/releases/tag/v1.0.0) (checked 2026-06-29; release metadata on GitHub)
...
3. [Chapter 3: Providers and Model Routing](03-providers-and-routing.md)
4. [Chapter 4: Prompt-to-App Workflow](04-prompt-to-app-workflow.md)
5. [Chapter 5: Files, Diff, and Locking](05-files-diff-locking.md)
6. [Chapter 6: Integrations and MCP](06-integrations-and-mcp.md)
7. [Chapter 7: Deployment and Distribution](07-deployment-distribution.md)
