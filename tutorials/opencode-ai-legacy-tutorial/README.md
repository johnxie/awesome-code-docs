...
- stars: about **13k**
- GitHub release reference: [`v0.0.55`](https://github.com/opencode-ai/opencode/releases/tag/v0.0.55) (checked 2026-06-22; release metadata on GitHub)
- status: **archived**
...
2. [Chapter 2: Legacy Architecture and Feature Model](02-legacy-architecture-and-feature-model.md)
3. [Chapter 3: Installation and Configuration Baseline](03-installation-and-configuration-baseline.md)
4. [Chapter 4: Model Providers and Runtime Operations](04-model-providers-and-runtime-operations.md)
5. [Chapter 5: Interactive and Non-Interactive Workflows](05-interactive-and-non-interactive-workflows.md)
6. [Chapter 6: Session, Tooling, and Integration Practices](06-session-tooling-and-integration-practices.md)
7. [Chapter 7: Migration to Crush and Modern Alternatives](07-migration-to-crush-and-modern-alternatives.md)
8. [Chapter 8: Legacy Governance and Controlled Sunset](08-legacy-governance-and-controlled-sunset.md)
