...
- stars: about **7k**
- GitHub release reference: [`v1.7.9`](https://github.com/modelcontextprotocol/registry/releases/tag/v1.7.9) (checked 2026-07-06; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and First Publish](01-getting-started-and-first-publish.md)
...
1. [Chapter 1: Getting Started and First Publish](01-getting-started-and-first-publish.md)
2. [Chapter 2: Registry Architecture and Data Flow](02-registry-architecture-and-data-flow.md)
3. [Chapter 3: server.json Schema and Package Verification](03-server-json-schema-and-package-verification.md)
4. [Chapter 4: Authentication Models and Namespace Ownership](04-authentication-models-and-namespace-ownership.md)
5. [Chapter 5: API Consumption, Subregistries, and Sync Strategies](05-api-consumption-subregistries-and-sync-strategies.md)
6. [Chapter 6: Versioning, Governance, and Moderation Lifecycle](06-versioning-governance-and-moderation-lifecycle.md)
7. [Chapter 7: Admin Operations, Deployment, and Observability](07-admin-operations-deployment-and-observability.md)
8. [Chapter 8: Production Rollout, Automation, and Contribution](08-production-rollout-automation-and-contribution.md)
