...
- stars: about **5.1k**
- GitHub release reference: [`v1.5.0`](https://github.com/cloudflare/vibesdk/releases/tag/v1.5.0) (checked 2026-06-02; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and Deployment Paths](01-getting-started-and-deployment-paths.md)
...
1. [Chapter 1: Getting Started and Deployment Paths](01-getting-started-and-deployment-paths.md)
2. [Chapter 2: System Architecture](02-system-architecture.md)
3. [Chapter 3: AI Pipeline and Phase Engine](03-ai-pipeline-and-phase-engine.md)
4. [Chapter 4: Sandbox and Preview Runtime](04-sandbox-and-preview-runtime.md)
5. [Chapter 5: Data Layer and Persistence](05-data-layer-and-persistence.md)
6. [Chapter 6: API, SDK, and Integrations](06-api-sdk-and-integrations.md)
7. [Chapter 7: Security, Auth, and Governance](07-security-auth-and-governance.md)
8. [Chapter 8: Production Operations and Scaling](08-production-operations-and-scaling.md)
