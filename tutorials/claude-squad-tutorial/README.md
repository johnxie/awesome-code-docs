...
- stars: about **7.9k**
- GitHub release reference: [`v1.0.19`](https://github.com/smtg-ai/claude-squad/releases/tag/v1.0.19) (checked 2026-06-22; release metadata on GitHub)
...
2. [Chapter 2: tmux and Worktree Architecture](02-tmux-and-worktree-architecture.md)
3. [Chapter 3: Session Lifecycle and Task Parallelism](03-session-lifecycle-and-task-parallelism.md)
4. [Chapter 4: Multi-Agent Program Integration](04-multi-agent-program-integration.md)
5. [Chapter 5: Review, Checkout, and Push Workflow](05-review-checkout-and-push-workflow.md)
6. [Chapter 6: AutoYes, Daemon Polling, and Safety Controls](06-autoyes-daemon-polling-and-safety-controls.md)
7. [Chapter 7: Configuration and State Management](07-configuration-and-state-management.md)
