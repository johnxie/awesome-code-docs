...
- stars: about **145k**
- GitHub release reference: [`langchain-core==1.6.0`](https://github.com/langchain-ai/langchain/releases/tag/langchain-core==1.6.0) (checked 2026-08-24; release metadata on GitHub)
