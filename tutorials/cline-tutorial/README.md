...
- stars: about **66.3k**
- GitHub release reference: [`desktop-v0.0.13`](https://github.com/cline/cline/releases/tag/desktop-v0.0.13) (checked 2026-08-17; release metadata on GitHub)
...
2. [Chapter 2: Agent Workflow](02-agent-workflow.md)
3. [Chapter 3: File Editing and Diffs](03-file-editing-and-diffs.md)
4. [Chapter 4: Terminal and Runtime Tools](04-terminal-and-runtime-tools.md)
5. [Chapter 5: Browser Automation](05-browser-automation.md)
6. [Chapter 6: MCP and Custom Tools](06-mcp-and-custom-tools.md)
7. [Chapter 7: Context and Cost Control](07-context-and-cost-control.md)
8. [Chapter 8: Team and Enterprise Operations](08-team-and-enterprise-operations.md)
