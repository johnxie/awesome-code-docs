...
- stars: about **22.6k**
- GitHub release reference: [`0.85.0`](https://github.com/activepieces/activepieces/releases/tag/0.85.0) (checked 2026-06-08; release metadata on GitHub)
...
2. [Chapter 2: System Architecture: App, Worker, Engine](02-system-architecture-app-worker-engine.md)
3. [Chapter 3: Flow Design, Versioning, and Debugging](03-flow-design-versioning-and-debugging.md)
4. [Chapter 4: Piece Development Framework](04-piece-development-framework.md)
5. [Chapter 5: Installation and Environment Configuration](05-installation-and-environment-configuration.md)
6. [Chapter 6: Admin Governance and AI Provider Control](06-admin-governance-and-ai-provider-control.md)
7. [Chapter 7: API Automation and Embedding Patterns](07-api-automation-and-embedding-patterns.md)
8. [Chapter 8: Production Operations, Security, and Contribution](08-production-operations-security-and-contribution.md)
