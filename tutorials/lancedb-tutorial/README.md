...
- stars: about **10.5k**
- GitHub release reference: [`python-v0.33.1-beta.2`](https://github.com/lancedb/lancedb/releases/tag/python-v0.33.1-beta.2) (checked 2026-06-08; release metadata on GitHub)
...
1. [Chapter 1: Getting Started with LanceDB](01-getting-started.md)
2. [Chapter 2: Data Modeling](02-data-modeling.md)
3. [Chapter 3: Vector Operations](03-vector-operations.md)
4. [Chapter 4: Hybrid Search](04-hybrid-search.md)
5. [Chapter 5: Integrations](05-integrations.md)
6. [Chapter 6: Performance](06-performance.md)
7. [Chapter 7: Production Deployment](07-production.md)
