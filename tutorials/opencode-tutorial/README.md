...
- stars: about **180k**
- GitHub release reference: [`v1.17.11`](https://github.com/anomalyco/opencode/releases/tag/v1.17.11) (checked 2026-06-29; release metadata on GitHub)
...
2. [Chapter 2: Architecture and Agent Loop](02-architecture-agent-loop.md)
3. [Chapter 3: Model and Provider Routing](03-model-and-provider-routing.md)
4. [Chapter 4: Tools, Permissions, and Execution](04-tools-permissions-and-execution.md)
5. [Chapter 5: Agents, Subagents, and Planning](05-agents-subagents-and-planning.md)
6. [Chapter 6: Client/Server and Remote Workflows](06-client-server-and-remote-workflows.md)
7. [Chapter 7: Integrations: MCP, LSP, and Extensions](07-integrations-mcp-lsp-and-extensions.md)
8. [Chapter 8: Production Operations and Security](08-production-operations-security.md)
