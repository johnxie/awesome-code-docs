...
- stars: about **66.1k**
- GitHub release reference: [`v1.10.0`](https://github.com/Fission-AI/OpenSpec/releases/tag/v1.10.0) (checked 2026-08-24; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and OPSX Basics](01-getting-started-and-opsx-basics.md)
...
1. [Chapter 1: Getting Started and OPSX Basics](01-getting-started-and-opsx-basics.md)
2. [Chapter 2: Artifact Graph and Change Lifecycle](02-artifact-graph-and-change-lifecycle.md)
3. [Chapter 3: Command Surface and Agent Workflows](03-command-surface-and-agent-workflows.md)
4. [Chapter 4: Spec Authoring, Delta Patterns, and Quality](04-spec-authoring-delta-patterns-and-quality.md)
5. [Chapter 5: Customization, Schemas, and Project Rules](05-customization-schemas-and-project-rules.md)
6. [Chapter 6: Tool Integrations and Multi-Agent Portability](06-tool-integrations-and-multi-agent-portability.md)
7. [Chapter 7: Validation, Automation, and CI Operations](07-validation-automation-and-ci-operations.md)
8. [Chapter 8: Migration, Governance, and Team Adoption](08-migration-governance-and-team-adoption.md)
