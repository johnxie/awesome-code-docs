---
layout: default
title: "Awesome Claude Skills Tutorial"
nav_order: 153
has_children: true
format_version: v2
---
...
[![GitHub Repo](https://img.shields.io/badge/GitHub-ComposioHQ%2Fawesome--claude--skills-black?logo=github)](https://github.com/ComposioHQ/awesome-claude-skills)
[![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
[![Releases](https://img.shields.io/badge/releases-none-lightgrey)](https://github.com/ComposioHQ/awesome-claude-skills/releases)
...
```mermaid
flowchart LR
    A[Task requirement] --> B[Find candidate skills by category]
    B --> C[Validate quality and safety]
    C --> D[Install and test in Claude workflow]
    D --> E[Keep only skills that compound outcomes]
    E --> F[Contribute improved skills back]
```
...
2. [Chapter 2: Catalog Taxonomy and Navigation](02-catalog-taxonomy-and-navigation.md)
3. [Chapter 3: Installation Paths: Claude.ai, Claude Code, API](03-installation-paths-claude-ai-claude-code-api.md)
4. [Chapter 4: Skill Authoring Template and Quality Standards](04-skill-authoring-template-and-quality-standards.md)
5. [Chapter 5: App Automation via Composio Skill Packs](05-app-automation-via-composio-skill-packs.md)
6. [Chapter 6: Contribution Workflow and Repository Governance](06-contribution-workflow-and-repository-governance.md)
7. [Chapter 7: Risk Management and Skill Selection Rubric](07-risk-management-and-skill-selection-rubric.md)
8. [Chapter 8: Team Adoption and Ongoing Maintenance](08-team-adoption-and-ongoing-maintenance.md)
