...
- [Start Here: Chapter 1: Getting Started and Repository Topology](01-getting-started-and-repository-topology.md)
...
1. [Chapter 1: Getting Started and Repository Topology](01-getting-started-and-repository-topology.md)
2. [Chapter 2: Weather Server Patterns Across Languages](02-weather-server-patterns-across-languages.md)
3. [Chapter 3: MCP Client Patterns and LLM Chat Loops](03-mcp-client-patterns-and-llm-chat-loops.md)
4. [Chapter 4: Protocol Flow and stdio Transport Behavior](04-protocol-flow-and-stdio-transport-behavior.md)
5. [Chapter 5: Smoke Tests and Mock Infrastructure](05-smoke-tests-and-mock-infrastructure.md)
6. [Chapter 6: Cross-Language Consistency and Extension Strategy](06-cross-language-consistency-and-extension-strategy.md)
7. [Chapter 7: CI, Toolchain Setup, and Troubleshooting](07-ci-toolchain-setup-and-troubleshooting.md)
8. [Chapter 8: From Tutorial Assets to Production Systems](08-from-tutorial-assets-to-production-systems.md)
