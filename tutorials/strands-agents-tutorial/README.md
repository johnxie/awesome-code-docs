...
- stars: about **6.7k**
- GitHub release reference: [`typescript/v1.11.1`](https://github.com/strands-agents/sdk-python/releases/tag/typescript/v1.11.1) (checked 2026-07-27; release metadata on GitHub)
...
2. [Chapter 2: Agent Loop and Model-Driven Architecture](02-agent-loop-and-model-driven-architecture.md)
3. [Chapter 3: Tools and MCP Integration](03-tools-and-mcp-integration.md)
4. [Chapter 4: Model Providers and Runtime Strategy](04-model-providers-and-runtime-strategy.md)
5. [Chapter 5: Hooks, State, and Reliability Controls](05-hooks-state-and-reliability-controls.md)
6. [Chapter 6: Multi-Agent and Advanced Patterns](06-multi-agent-and-advanced-patterns.md)
