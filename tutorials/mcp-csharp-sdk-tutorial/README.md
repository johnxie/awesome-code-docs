...
- stars: about **4.3k**
- GitHub release reference: [`v1.3.0`](https://github.com/modelcontextprotocol/csharp-sdk/releases/tag/v1.3.0) (checked 2026-06-02; release metadata on GitHub)
...
- [Start Here: Chapter 1: Getting Started and Package Selection](01-getting-started-and-package-selection.md)
...
1. [Chapter 1: Getting Started and Package Selection](01-getting-started-and-package-selection.md)
2. [Chapter 2: Client/Server Hosting and stdio Basics](02-client-server-hosting-and-stdio-basics.md)
3. [Chapter 3: ASP.NET Core HTTP Transport and Session Routing](03-aspnetcore-http-transport-and-session-routing.md)
4. [Chapter 4: Tools, Prompts, Resources, and Filter Pipelines](04-tools-prompts-resources-and-filter-pipelines.md)
5. [Chapter 5: Logging, Progress, Elicitation, and Tasks](05-logging-progress-elicitation-and-tasks.md)
6. [Chapter 6: OAuth-Protected MCP Servers and Clients](06-oauth-protected-mcp-servers-and-clients.md)
7. [Chapter 7: Diagnostics, Versioning, and Breaking-Change Management](07-diagnostics-versioning-and-breaking-change-management.md)
8. [Chapter 8: Testing, Operations, and Contribution Workflows](08-testing-operations-and-contribution-workflows.md)
