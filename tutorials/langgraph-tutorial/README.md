...
- stars: about **39.4k**
- GitHub release reference: [`checkpointpostgres==3.1.2`](https://github.com/langchain-ai/langgraph/releases/tag/checkpointpostgres==3.1.2) (checked 2026-08-10; release metadata on GitHub)
...
> **LangGraph Studio Transition**: As of March 2025 (v0.0.37), LangGraph Studio Desktop is deprecated. Use the [LangGraph CLI docs](https://langchain-ai.github.io/langgraph/cloud/reference/cli/) for local development and debugging.
...
1. [Chapter 1: Getting Started with LangGraph](01-getting-started.md)
2. [Chapter 2: State Management](02-state-management.md)
3. [Chapter 3: Nodes and Edges](03-nodes-edges.md)
4. [Chapter 4: Conditional Logic](04-conditional-logic.md)
5. [Chapter 5: Multi-Agent Systems](05-multi-agent-systems.md)
6. [Chapter 6: Tool Integration](06-tool-integration.md)
7. [Chapter 7: Persistence and Checkpoints](07-persistence-checkpoints.md)
